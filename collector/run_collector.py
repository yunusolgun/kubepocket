...
from collector.weekly_report import send_weekly_report, should_send_report
import sys
import os
import time
            ...
            for pvc in pvcs:
                if not pvc['bound']:
                    ...
                    if not existing:
                        ...
                        if a: new_alert_ids.append(a.id)
...
def _try_send_weekly_report():
    """Send weekly report if schedule matches current UTC time."""
